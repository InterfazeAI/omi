...
def main():
    parser = argparse.ArgumentParser(description='Omi Pendant UF2 Builder')
    ...
    if args.output:
        ...
        uf2_path = f"omi_pendant_{base_name}.uf2"
    ...
    if create_uf2_file(binary_path, uf2_path):
        ...
        print()
        print("🔍 Monitor with: pio device monitor --baud 921600")
